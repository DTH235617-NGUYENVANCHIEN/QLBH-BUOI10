...
// thư viên BCrypt.Net-Next để mã hóa mật khẩu
...
namespace QuanLiBanHang.Forms
{
    public partial class frmMain : Form
    {
        ...
        {
            frmThongKeSanPham thongKeSanPham = new frmThongKeSanPham();
        ...
        {
            //hiên thị form thống kê doanh thu
            frmThongKeDoanhThu thongKeDoanhThu = new frmThongKeDoanhThu();
