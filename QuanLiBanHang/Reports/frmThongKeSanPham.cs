...
namespace QuanLiBanHang.Reports
{
    public partial class frmThongKeSanPham : Form
    {
        ...
        {
            // Lấy danh sách từ Entity Framework context
            var dsLoai = context.LoaiSanPham.ToList();

            cboLoaiSanPham.DataSource = dsLoai;
            cboLoaiSanPham.DisplayMember = "TenLoai"; // Kiểm tra lại tên cột trong DB của bạn
            cboLoaiSanPham.ValueMember = "ID";        // Thường là ID hoặc MaLoai tùy DB
        ...
        public void LayHangSanXuatVaoComboBox()
        {
            ...
            cboHangSanXuat.DisplayMember = "TenHangSanXuat"; // Khớp với tên thuộc tính trong class SanPham bạn dùng ở Load
